...
If we're using [Joi](https://github.com/hapijs/joi) all over the place for doing validations of our objects, then why not instrument the functions on these objects with Joi validations as well.
